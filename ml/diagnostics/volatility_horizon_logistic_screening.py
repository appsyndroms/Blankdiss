"""Kontrollerad jämförelse av 20d/60d-volatilitet och volatilitetsskillnad."""
...
def main() -> None:
    print(
        "BLANKDISS VOLATILITY HORIZON LOGISTIC SCREENING"
    )
    print(
    ...
    print(
        "Question: Ligger signalen i VOL20, "
        "VOL60 eller förändringen VOL20-VOL60?"
    )
    print(
