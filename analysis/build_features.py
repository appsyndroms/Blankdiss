...
# Konvertera pandas/numpy-NaN och NaT
# till riktiga Python None-värden.
#
# Viktigt: astype(object) måste göras först.
# Annars kan pandas behålla float-dtype och
# lämna NaN kvar trots where(..., None).
...
Kör sedan `python -m analysis.build_features` igen.
