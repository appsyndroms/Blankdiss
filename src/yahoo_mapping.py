...
def yahoo_search(
    ...
    """
    Söker efter finansiella instrument via Yahoo.

    Ett misslyckat eller långsamt anrop
...
def choose_yahoo_symbol(
    ...
    """
    Hittar bästa Yahoo-symbol för en svensk emittent.
...
def get_latest_fi_records(
    ...
    """Hämtar senaste FI-observation per LEI."""
...
def resolve_one_mapping(
    ...
    """Mappning av en enskild emittent."""
...
def build_instrument_map(
    ...
    """
    Kompletterar instrumentmappningen.

    Befintliga mappingar söks aldrig om.

    Nya sökningar körs parallellt.
    """
    ...
    latest_by_lei = get_latest_fi_records(
        fi_records
    )
...
def get_yahoo_symbols(
    ...
    """Returnerar alla unika mappade Yahoo-instrument."""
